...
public class RegisterViewModel extends ViewModel {
    ...
    public MutableLiveData<String> cozinha = new MutableLiveData<>("");  //Inicializado com um valor inteiro
    ...
    public void doRegister(){
        userRepository.register(username.getValue(), email.getValue(), password.getValue(),
                nameUser.getValue(), phoneNumber.getValue(), address.getValue(), locale.getValue(),
                postalCode.getValue(), role.getValue(), 0, response -> {
